---
title: Workflow und Planung - Optimierung und Beschleunigung der Arbeit
description: Für Unternehmen, die Schwierigkeiten haben, ihre Inhaltsanforderungen durch den Planungsprozess bis zur Inhaltserstellung und -fertigstellung zu verbinden und zu verfolgen. Mangelnde effiziente Prozesse, Planung, Validierungen und projektübergreifende Datenkonsistenz führen zu einer Verringerung der Produktivität und Effizienz der Inhaltslieferkette dieses Unternehmens.
...
# Workflow und Planung: Optimierung und Beschleunigung der Arbeit

Dies ist für das Unternehmen, das Schwierigkeiten hat, sich zu verbinden und seine Inhaltsanforderungen von der Planung über die Produktion bis zur Fertigstellung zu verfolgen. Mangelnde effiziente Prozesse, Planung, Validierungen und projektübergreifende Datenkonsistenz machen die Inhaltslieferkette dieses Unternehmens sowohl produktiv als auch effizient.

Die für die Planung und den Workflow verwendeten Adobe-Lösungen:
...
* Vereinfachung von Workflows und Genehmigungen
* Optimieren der Ausgaben und Ressourcen
* Größere Sichtbarkeit von Kapazitäten, Projekten, Risiken und Zeitplänen
* Automatisieren nachgelagerter Prozesse, wie Metadaten-Tagging
    ...
    <tr>
      <td style="width:33%">
        <a href="https://experienceleague.adobe.com/docs/courses/using/experiencemanager-u-1-2023-assets-essentials.html" target="_blank">
          <img alt="Erste Schritte mit AEM Assets Essentials" src="https://cdn.experienceleague.adobe.com/thumb/getting-started-with-assets-essentials.png">
        </a>
        <div>
          <a href="https://experienceleague.adobe.com/docs/courses/using/experiencemanager-u-1-2023-assets-essentials.html" target="_blank">
      ...
      <td style="width:33%">
        <a href="https://experienceleague.adobe.com/docs/courses/using/experiencemanager-a-1-2020-1-assets.html" target="_blank">
          <img alt="Miniaturbild für das Tutorial &quot;Konfigurieren von AEM Assets für Administratoren&quot;" src="https://cdn.experienceleague.adobe.com/thumb/configuring-aem-assets-for-administrators.jpg">
        </a>
        <div>
          <a href="https://experienceleague.adobe.com/docs/courses/using/experiencemanager-a-1-2020-1-assets.html" target="_blank">
...
<div class="columns is-multiline"><div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Integrate Adobe Workfront and AEM Assets Essentials" tabIndex="0">
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/overview.html" title="Integration von Adobe Workfront und AEM Assets Essentials" tabindex="-1">
          <img class="is-bordered-r-small" src="https://cdn.experienceleague.adobe.com/thumb/docs-workfront.png" alt="Integration von Adobe Workfront und AEM Assets Essentials">
        </a>
      </figure>
    </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-creative-cloud/wf-adobe-cc.html" title="Verwenden von Adobe Workfront-Plug-ins zur Integration mit Creative Cloud" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3415452?format=jpeg" alt="Verwenden von Adobe Workfront-Plug-ins zur Integration mit Creative Cloud">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/configure.html?lang=de" title="Konfigurieren von Adobe Workfront- und AEM Assets-Grundlagen" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/336254?format=jpeg" alt="Konfigurieren von Adobe Workfront- und AEM Assets-Grundlagen">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/configure.html?lang=de" title="Konfigurieren von Adobe Workfront- und AEM Assets-Grundlagen">Konfigurieren von Adobe Workfront- und AEM Assets-Grundlagen</a>
          </p>
          <p class="is-size-6"><em>Erfahren Sie, wie Sie die Adobe Workfront- und Assets Essentials-Integration konfigurieren.</em></p>
      </div>
      <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/configure.html?lang=de" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
        <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Video ansehen</span>
      </a>
    </div>
  </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/basics.html?lang=de" title="Grundlagen zum erweiterten Workfront-Connector" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/337575?format=jpeg" alt="Grundlagen zum erweiterten Workfront-Connector">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      ...
      <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/basics.html?lang=de" class="spectrum-Button spectrum-Button--outline spectrum-Button--primary spectrum-Button--sizeM" style="align-self: flex-start; margin-top: 1rem;">
        <span class="spectrum-Button-label has-no-wrap has-text-weight-bold">Video ansehen</span>
      </a>
    </div>
  </div>
  ...
  <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
    <div class="card-image">
      <figure class="image x-is-16by9">
        <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/aem-experts-series/overview.html" title="Integrieren von Workfront und AEM Assets mit dem erweiterten Connector" tabindex="-1">
          <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/340331?format=jpeg" alt="Integrieren von Workfront und AEM Assets mit dem erweiterten Connector">
        </a>
      </figure>
    </div>
    <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
      <div class="top-card-content">
          <p class="headline is-size-6 has-text-weight-bold">
              <a href="https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/aem-experts-series/overview.html" title="Integrieren von Workfront und AEM Assets mit dem erweiterten Connector">Integrieren von Workfront und AEM Assets mit dem erweiterten Connector</a>
          </p>
          <p class="is-size-6"><em>Die vierteilige Videoserie zur Integration von Workfront und AEM Assets mithilfe des erweiterten Connectors enthält Informationen zu vier Themen:</em></p>
      </div>
